...
public class MyPageReportAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            if (holder instanceof MyPageReportViewHolder) {
                MyPageReportViewHolder vh = (MyPageReportViewHolder) holder;
